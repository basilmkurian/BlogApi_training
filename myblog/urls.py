...
from .views import BlogListAPIView, BlogDetailAPIView, TopAuthorsAPIView, PopularCategoryAPIView, BlogCreateAPIView, AuthorCreateAPIView, CategoryCreateAPIView, DraftListView
...
urlpatterns = [
    ...
    path('api/blogs/drafts/', DraftListView.as_view(), name='draft-list'),
]
